...
# Remove lines 3-10 (both included) of the api/*.rst files of the packages (like datasets or preprocessing)
...
sed -i'.original' -e '3,10d' api/topics_and_summary.datasets.rst
sed -i'.original' -e '3,10d' api/topics_and_summary.models.rst
sed -i'.original' -e '3,10d' api/topics_and_summary.preprocessing.rst
